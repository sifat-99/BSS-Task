<h1 align="center">
    BSS-Task: Web Development Projects & Learning Modules using HTML, CSS, and JavaScript
</h1>
<div align="center">
...
│   ├── challange/
│   ├── challange image overlay/
│   ├── is where has properties/
│   ├── nth of type/
│   └── styling forms/
├── Box Model/
│   ├── challange/
...
<details>
<summary style="font-size: 32px; font-weight: bold; border: 1px solid #888; padding: 15px; border-radius: 5px; cursor: pointer;">📸 See more screenshots</summary>
<br>
...
- [**CSS Basics**](./CSS%20Basics): Properties, selectors, cascading rules, colors, and foundational styling (**🔗 [Live Challenge Demo](https://bss-task-1nid.vercel.app/)**)
...
- [**Advanced Selectors**](./Advanced%20Selectors%20Pseudo%20Classes%20Elements): Exploring high-level targeting utilizing pseudo-classes (e.g., `:hover`, `:nth-child`) and pseudo-elements (e.g., `::before`, `::after`) (**🔗 [Live Challenge Demo](https://advance-selector.vercel.app/)**)
...
- [**Flexbox**](./Flexbox): Practical exercises showcasing 1-dimensional layouts, alignment, flex behaviors, and spacing distributions (**🔗 [Live Challenge Demo](https://bss-task-bboa.vercel.app/)**)
...
- [**Transitions, Animation & A Little JavaScript**](./Transitions%20Animation%20A%20Little%20JavaScript): Bringing standard, static web pages to life. This module covers implementing keyframes, smooth CSS transitions, interactive 3D transforms, and leveraging basic JavaScript constraints to trigger effects (**🔗 [Presentation Website Live Demo](https://presentation-website-pink.vercel.app/#page-2)**) | (**🔗 [Hamburger Menu Live Demo](https://bss-task-zvty.vercel.app/)**)
